    ...
    <div class="space-y-8">
        ...
        >
            <Avatar class="h-9 w-9">
                ...
                <AvatarFallback>{{ order.orderBy.Ho.charAt(0) }}{{ order.orderBy.Ten.charAt(0) }}</AvatarFallback>
            </Avatar>
            <div class="ml-4 space-y-1">
                <p class="text-sm font-medium leading-none">{{ order.orderBy.Ho }} {{ order.orderBy.Ten }}</p>
